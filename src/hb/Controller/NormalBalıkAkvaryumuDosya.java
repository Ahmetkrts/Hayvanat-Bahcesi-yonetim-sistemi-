 ...
 * @author Casper
 */
public class NormalBalıkAkvaryumuDosya {

    private String hayvanDosyaYolu = "NormalBalıkAkvaryumu.dat";
    ...
    public List<Hayvan2> hayvanDosyaOku() {
        ...
        try (ObjectInputStream hayvanDosyasi = new ObjectInputStream(new BufferedInputStream(new FileInputStream(hayvanDosyaYolu)))) {
            ...
            Logger.getLogger(NormalBalıkAkvaryumuDosya.class.getName()).log(Level.SEVERE, null, ex);
        }
