 ...
 * @author Casper
 */
public class NormalAcikAlanDosya {

    private String hayvanDosyaYolu = "NormalAcikAlan.dat";
    ...
    public List<Hayvan2> hayvanDosyaOku() {
        ...
        try (ObjectInputStream hayvanDosyasi = new ObjectInputStream(new BufferedInputStream(new FileInputStream(hayvanDosyaYolu)))) {
            ...
            Logger.getLogger(NormalAcikAlanDosya.class.getName()).log(Level.SEVERE, null, ex);
        }
