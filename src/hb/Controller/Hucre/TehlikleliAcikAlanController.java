 ...
 * @author Casper
 */
public class TehlikleliAcikAlanController implements Initializable {
    ...
    TehlikeliAcikAlanDosya dosya = new TehlikeliAcikAlanDosya();
    @FXML
        ...
        alert.showAndWait().ifPresent(rs -> {
            if (rs == ButtonType.OK) {
                try {
                    ...
                    Logger.getLogger(TehlikleliAcikAlanController.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
    ...
    private void kapasite(){
        ...
        this.kapasiteLabel.setText("Kapasite ="+this.kapasite.getTehlikeliAcikAlanKapasite()+"/50");
    }
}
