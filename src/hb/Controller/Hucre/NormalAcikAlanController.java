 ...
 * @author Casper
 */
public class NormalAcikAlanController implements Initializable {
    ...
    NormalAcikAlanDosya dosya = new NormalAcikAlanDosya();
    @FXML
        ...
        alert.showAndWait().ifPresent(rs -> {
            if (rs == ButtonType.OK) {
                try {
                    ...
                    Logger.getLogger(NormalAcikAlanController.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
