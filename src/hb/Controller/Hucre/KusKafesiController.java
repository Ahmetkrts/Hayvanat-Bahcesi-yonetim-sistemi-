 ...
 * @author Casper
 */
public class KusKafesiController implements Initializable {
        ...
        alert.showAndWait().ifPresent(rs -> {
            if (rs == ButtonType.OK) {
                try {
                    ...
                    Scene scene = new Scene(fxmlLoader.load(), 1190, 439);
                    ...
                    Logger.getLogger(KusKafesiController.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
    ...
    private void kapasite(){
        ...
        this.kapasiteLabel.setText("Kapasite ="+this.kapasite.getKusKapasite()+"/50");
    }
}
