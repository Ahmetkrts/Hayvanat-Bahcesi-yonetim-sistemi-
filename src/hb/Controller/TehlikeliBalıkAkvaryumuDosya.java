 ...
 * @author Casper
 */
public class TehlikeliBalıkAkvaryumuDosya {

    private String hayvanDosyaYolu = "TehlikeliBalıkAkvaryumu.dat";
    ...
    public List<Hayvan2> hayvanDosyaOku() {
        ...
        try (ObjectInputStream hayvanDosyasi = new ObjectInputStream(new BufferedInputStream(new FileInputStream(hayvanDosyaYolu)))) {
            ...
            Logger.getLogger(TehlikeliBalıkAkvaryumuDosya.class.getName()).log(Level.SEVERE, null, ex);
        }
