 ...
 * @author Casper
 */
public class TehlikeliAcikAlanDosya {

    private String hayvanDosyaYolu = "TehlikeliAcikAlan.dat";
    ...
    public List<Hayvan2> hayvanDosyaOku() {
        ...
        try (ObjectInputStream hayvanDosyasi = new ObjectInputStream(new BufferedInputStream(new FileInputStream(hayvanDosyaYolu)))) {
            ...
            Logger.getLogger(TehlikeliAcikAlanDosya.class.getName()).log(Level.SEVERE, null, ex);
        }
